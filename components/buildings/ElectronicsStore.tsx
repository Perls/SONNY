...
const STORE_STOCK = ['walkman', 'pager', 'gameboy', 'discman', 'boombox', 'camcorder', 'brick_phone', 'wang_3000', 'coffee_machine'];
...
const COMMERCIALS: Record<string, string> = {
    ...
    'wang_3000': "🖥️ THE FUTURE IS HERE! 33MHz of raw processing power! Do your taxes! Play solitaire! Hack the planet!",
    'coffee_machine': "☕ WAKE UP! The 'Jitterbug 2000' brews faster than you can think! Essential for the modern hustler!",
};
